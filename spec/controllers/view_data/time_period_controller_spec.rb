...
RSpec.describe ViewData::TimePeriodController, type: :controller do
  describe "POST update" do
    ...
    let(:create_metrics) {
      ...
      6.times do
        FactoryGirl.create(:monthly_service_metrics, :published, service: service, month: month, transactions_processed: 300, transactions_processed_accepted: 200, transactions_processed_rejected: 100)
        month = month.succ
      end
    }
